<?php get_header();?>
		<h2 class="about-category-tags">Tag Archive for: <span class="cyan-color"><?php echo single_tag_title( '', false ); ?></span></h2>
			<?php if(tag_description()){ ?>
			<div class="col-sm-12 col-xs-12 about-category-tags">
				<span class="col-sm-3 col-xs-12 author-info">Tag description: </span>
				<span class="col-sm-9 col-xs-12"><?php echo tag_description(); ?></span>
			</div>
			<?php } ?>
